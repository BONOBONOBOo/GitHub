	  ...
	  <table border="0" cellpadding="0" cellspacing="1" width="640" bgcolor="BBBBBB">
	   <tr>
		  ...
		  <tr>
			...
			<textarea name="pdesc" cols="40" rows="10">${vo.pdesc}</textarea>
            </td>
